...
const BASE_URL = "https://base.org/";
const REGISTRY_URL = "https://www.base.org/ecosystem";
const BASE_LOGO = "/Base_Network_Logo.svg"

const createOnChainRegistryNode = () =>
...
const createCategoryNode = (registryData) =>
...
const filterDuplicateNode = (graphNodes) => {
...
const createGraphData = (registryData, depth = 3) => depth === 3 ? ({
...
// OR search
const searchObjectByValues = (registryData, searchValues) => {
...
// AND search
const andSearchObjectByValues = (registryData, searchValues) => {
    const lowerSearchValues = searchValues.map(value => value.toLowerCase());
    return registryData.filter(obj =>
...
const searchGraphDataByValues = async (searchValues, searchType = false, depth = 3) => {
    // Default AND search
